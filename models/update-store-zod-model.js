...
const {
  UpdateSocialMediaZodModel,
} = require("./update-social-media-zod-model");
const { phone } = require("phone");

const UpdateStoreZodModel = z.object({
  // store - restaurant - place for weddings

  name: UpdateLocaleZodModel, //
  bio: UpdateLocaleZodModel, // z.string({ message: "Please enter a description" }),
  logo: z
    .any()
    .refine(
      (file) =>
  ...
  phone: z
    ...
    .optional(),
  email: z.string({ message: "Please enter an email" }).optional(),
  socialLinks: UpdateSocialMediaZodModel,
  // socialLinks: z
  //   .object({
  //     tiktok: z
  //       .string()
...
module.exports = { UpdateStoreZodModel };
