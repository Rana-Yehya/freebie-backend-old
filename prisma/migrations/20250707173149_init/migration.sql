...
CREATE TABLE "product" (
    ...
    "nameId" TEXT,
    "descriptionId" TEXT,
    "detailedDescriptionId" TEXT,
    "price" DOUBLE PRECISION NOT NULL DEFAULT 1,
    "actualPrice" DOUBLE PRECISION NOT NULL DEFAULT 1,
...
-- AddForeignKey
ALTER TABLE "location" ADD CONSTRAINT "location_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "order"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "store" ADD CONSTRAINT "store_nameId_fkey" FOREIGN KEY ("nameId") REFERENCES "name"("id") ON DELETE SET NULL ON UPDATE SET NULL;
...
-- AddForeignKey
ALTER TABLE "country" ADD CONSTRAINT "country_nameId_fkey" FOREIGN KEY ("nameId") REFERENCES "name"("id") ON DELETE SET NULL ON UPDATE SET NULL;
...
-- AddForeignKey
ALTER TABLE "product" ADD CONSTRAINT "product_nameId_fkey" FOREIGN KEY ("nameId") REFERENCES "name"("id") ON DELETE SET NULL ON UPDATE SET NULL;

-- AddForeignKey
ALTER TABLE "product" ADD CONSTRAINT "product_descriptionId_fkey" FOREIGN KEY ("descriptionId") REFERENCES "name"("id") ON DELETE SET NULL ON UPDATE SET NULL;

-- AddForeignKey
ALTER TABLE "product" ADD CONSTRAINT "product_detailedDescriptionId_fkey" FOREIGN KEY ("detailedDescriptionId") REFERENCES "name"("id") ON DELETE SET NULL ON UPDATE SET NULL;
...
-- AddForeignKey
ALTER TABLE "productCart" ADD CONSTRAINT "productCart_userCartUserId_fkey" FOREIGN KEY ("userCartUserId") REFERENCES "userCart"("userId") ON DELETE RESTRICT ON UPDATE CASCADE;
