...
-- AddForeignKey
ALTER TABLE "public"."category" ADD CONSTRAINT "category_nameId_fkey" FOREIGN KEY ("nameId") REFERENCES "public"."locale"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."info" ADD CONSTRAINT "info_nameId_fkey" FOREIGN KEY ("nameId") REFERENCES "public"."locale"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."occasion" ADD CONSTRAINT "occasion_nameId_fkey" FOREIGN KEY ("nameId") REFERENCES "public"."locale"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."store_subscriptions" ADD CONSTRAINT "store_subscriptions_planLimitId_fkey" FOREIGN KEY ("planLimitId") REFERENCES "public"."plan_limits"("planName") ON DELETE SET NULL ON UPDATE CASCADE;
